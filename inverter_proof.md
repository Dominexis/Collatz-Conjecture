...
>
> $`\begin{align} x & = \frac{\frac{\frac{\frac{3^Lx + 3^{L-1}}{2^{s_0}} + 3^{L-2}}{2^{s_1}} \ldots + 3}{2^{s_{L-2}}} + 1}{2^{s_{L-1}}} \notag \end{align}`$
>
...
>
> $`\begin{align} \frac{2^{s_0 + s_1 \ldots s_{L-1}} - 3^L}{2^{s_0 + s_1 \ldots s_{L-1}}}x & = \frac{1}{2^{s_{L-1}}} + \frac{3}{2^{s_{L-2} + s_{L-1}}} \ldots \frac{3^{L-2}}{2^{s_1 \ldots s_{L-1}}} + \frac{3^{L-1}}{2^{s_0 + s_1 \ldots s_{L-1}}} \notag \end{align}`$
>
> $`\begin{align} \left(2^{s_0 + s_1 \ldots s_{L-1}} - 3^L\right)x & = 2^{s_0 + s_1 \ldots s_{L-2}} + 3 \times 2^{s_0 + s_1 \ldots s_{L-3}} \ldots 3^{L-2} \times 2^{s_0} + 3^{L-1} \notag \end{align}`$
>
> $`\begin{align} x & = \frac{2^{s_0 + s_1 \ldots s_{L-2}} + 3 \times 2^{s_0 + s_1 \ldots s_{L-3}} \ldots 3^{L-2} \times 2^{s_0} + 3^{L-1}}{2^{s_0 + s_1 \ldots s_{L-1}} - 3^L} \notag \end{align}`$
>
